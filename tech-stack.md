...
| ローカル LLM | OpenAI 互換 endpoint / Ollama | chat回答と、knowledge-vault / Slack / Misskey / AI相談の共通v3候補提案。action / aspirationを原文根拠付きで分け、ユーザーGOなしにVikunjaへ書かない |
...
| Misskey | 自分のnote回収、action / aspiration候補抽出 | payload以降だけ実装済み。外部取得方式はP1 PoC |
