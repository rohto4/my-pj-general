...
- `docs/arch/windows-vault-ai-intake-architecture-2026-07.md`は責務表を2本のMermaidシーケンス図へ変更済みである。
...
5. fake回帰完了後にsystemd/env例を同期するが、実token、実取込、Linux配信、timer有効化はユーザー確認なしに行わない。
